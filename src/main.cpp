...
int main() {
    ...
    Command("mod", "Base des commandes de modération")
            .add_subcommand("kick", "Expulser un membre du serveur", Commands::kickHandler, {
                    {dpp::co_user, "membre", "Le membre à expulser", true},
                    {dpp::co_string, "raison", "La raison de l'expulsion"}
            })
            .add_subcommand("ban", "Bannir un membre du serveur", Commands::banHandler, {
                    {dpp::co_user, "membre", "Le membre à bannir", true},
                    {dpp::co_string, "raison", "La raison du bannissement"}
            })
            .add_subcommand("unban", "Débannir un membre du serveur", Commands::unbanHandler, {
                    {dpp::co_user, "membre", "Le membre à débannir", true},
                    {dpp::co_string, "raison", "La raison du débannissement"}
            })
            .add_subcommand("clear", "Supprimer un nombre de messages (jusqu'à 2 semaines d'ancienneté)", Commands::clearHandler, {
